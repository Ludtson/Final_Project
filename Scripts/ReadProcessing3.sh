...
java -jar ~/.conda/pkgs/trimmomatic-0.39-1/share/trimmomatic-0.39-1/trimmomatic.jar  PE -threads 8 Plot1.3.raw.R1.fq Plot1.3.raw.R2.fq \
	Plot1.3.processed.1P.fastq \
	Plot1.3.processed.1U.fastq \
	Plot1.3.processed.2P.fastq \
	Plot1.3.processed.2U.fastq \
...
a=`cat Plot1.3.processed.1P.fastq  | wc -l` #storing the number of lines of file "1P" in variable 'a'
b=`cat Plot1.3.processed.2P.fastq | wc -l` #storing the number of lines of file "2P" in variable 'b'
